...
-- Дамп данных таблицы auth.account: ~0 rows (приблизительно)
DELETE FROM `account`;
...
INSERT INTO `account` (`id`, `username`, `sha_pass_hash`, `sessionkey`, `v`, `s`, `token_key`, `email`, `reg_mail`, `joindate`, `last_ip`, `last_attempt_ip`, `failed_logins`, `locked`, `lock_country`, `last_login`, `online`, `expansion`, `mutetime`, `mutereason`, `muteby`, `locale`, `os`, `recruiter`, `recruiter_rewarded`, `battlenet_account`, `battlenet_index`) VALUES
	(5, '4#1', '158E71C601400EFD35E6DA64EDB68421FC79983A', 'E6C38459C7C3D0250F1DDCBF10D4C3DDD10103DF2AF7C419BF8E83DACE0987F2DAB8AF4A5C489C9E', '', '', '', 'ZGN88@MAIL.RU', 'ZGN88@MAIL.RU', '2019-05-12 19:48:29', '127.0.0.1', '127.0.0.1', 0, 0, '00', '2019-05-12 19:56:09', 1, 7, 0, '', '', 8, 'Wn64', 0, 0, 4, 1);
...
-- Дамп данных таблицы auth.account_access: ~0 rows (приблизительно)
...
-- Дамп данных таблицы auth.account_last_played_character: ~1 rows (приблизительно)
...
-- Дамп данных таблицы auth.battlenet_accounts: ~0 rows (приблизительно)
...
-- Дамп данных таблицы auth.battlenet_account_mounts: ~0 rows (приблизительно)
...
-- Дамп данных таблицы auth.battlenet_item_appearances: ~4 rows (приблизительно)
...
-- Дамп данных таблицы auth.battle_pet_slots: ~3 rows (приблизительно)
...
-- Дамп данных таблицы auth.rbac_linked_permissions: ~668 rows (приблизительно)
...
-- Дамп данных таблицы auth.rbac_permissions: ~686 rows (приблизительно)
...
-- Дамп данных таблицы auth.realmcharacters: ~1 rows (приблизительно)
...
-- Дамп данных таблицы auth.realmlist: ~0 rows (приблизительно)
...
INSERT INTO `realmlist` (`id`, `name`, `address`, `localAddress`, `localSubnetMask`, `port`, `icon`, `flag`, `timezone`, `allowedSecurityLevel`, `population`, `gamebuild`, `Region`, `Battlegroup`) VALUES
	(1, 'Silverwing', '127.0.0.1', '127.0.0.1', '255.255.255.0', 8085, 0, 0, 1, 0, 0, 28153, 1, 1);
/*!40000 ALTER TABLE `realmlist` ENABLE KEYS */;

-- Дамп структуры для таблица auth.updates
...
-- Дамп данных таблицы auth.updates: 2 rows
DELETE FROM `updates`;
/*!40000 ALTER TABLE `updates` DISABLE KEYS */;
INSERT INTO `updates` (`name`, `hash`, `state`, `timestamp`, `speed`) VALUES
	('2019_02_20_00_auth.sql', 'B21B2CA9F6965636FEACA96F45B97FA99B99FA4B', 'RELEASED', '2019-05-09 08:31:35', 467),
	('2019_04_13_00_auth.sql', '900C58BDB79B2D2F22D07A46FE77A049C5B080FF', 'RELEASED', '2019-05-09 08:31:35', 341);
/*!40000 ALTER TABLE `updates` ENABLE KEYS */;

-- Дамп структуры для таблица auth.updates_include
...
-- Дамп данных таблицы auth.updates_include: 1 rows
...
-- Дамп данных таблицы auth.uptime: ~36 rows (приблизительно)
DELETE FROM `uptime`;
